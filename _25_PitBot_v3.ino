/*LEGO Episode #25
  Project :     PitBot Is Agressive? Well, No Worries!
                Making PitBot bite! Lego Episode #25
  Ino File:     _25_PitBot_v3.ino
  Flavour 03
  Date: Jul 2019
  Description:  In This code, we’re gonna make PitBot Run after a yellow cup :|
                PitBot is a pitbull dog’s robot-like that will be used for LEGO’s Sumo Training :)
